...
// //             handleMeasurementChange(field, value, range?.[0], range?.[1]);

// //             // 2 digits hone par next field pe jao
// //             if (value.length === 2) {
// //               const nextField = allFields[globalIndex + 1];
// //               if (nextField) {
// //                 document.getElementById(`measure-${nextField}`)?.focus();
// //               }
// //             }
// //           }}
// //           onBlur={handleBlur}
...
//       productId: product._id,
//       name: product.name,
//       price: showCustom ? product.new_price + 2000 : product.new_price,
//       image: selectedImage,
//       size: finalSize, 
//       measurements,
//       quantity,
...
//     Rs {showCustom ? product.new_price + 2000 : product.new_price}
//   </span>
//   {showCustom && (
//     <span style={{ fontSize: "12px", color: "green", marginLeft: "8px" }}>
//       + Rs 2000 customization charges
//     </span>
//   )}
// </p>
//               {/* <div className="product-rating">
...
const ProductDetailPage = () => {
  ...
  const handleAddToCart = async () => {
    ...
    const availableStock = showCustom ? (product.customStock ?? 0) : product.stock[selectedSize] || 0;
  ...
  const hasCustomStock = product.customStock != null;
        ...
        <div className="info-section">
          ...
          <div className="cart-section">
            ...
            <input
              type="number"
              min={1}
              max={showCustom ? (product.customStock ?? 0) : product.stock[selectedSize] || 0}
              value={quantity}
              onChange={handleQuantityChange}
            />
            <button
              ...
              onClick={handleAddToCart}
              disabled={
                (selectedSize && !showCustom && product.stock[selectedSize] === 0) ||
                (showCustom && (product.customStock ?? 0) === 0)
              }
            >
              Add to Cart
            </button>
